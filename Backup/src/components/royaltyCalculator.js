...
class royaltyCalculator extends Component {
    constructor() {
      ...
      handleValidation1(){
        ...
        if(setminprice == ''){
          ...
          errors["setminprice"] = "Please enter the valid Selling Price";
        }
        ...
        var setohterprice =  0;
          ...
          errors["setminprice"] = "Selling Price should be more than Minimum recommended Price";
        }
 ...
 <ProductWrapper>
   ...
   <div className="container ">
     <h3 className="text-center mt-5">  Calculate Author Earnings</h3>
   ...
   <div className="container">
     ...
     <div className="col-md-6 sm-pd">
            <div className="card br-20 shadow" style={{padding: '2rem', backgroundColor: 'white', borderRadius: '20px'}}>
              <div className="card-header bg-gradient br-10" style={{paddingBottom: '20px'}}>
...
<span style={{color: "red"}}>{this.state.errors["name"]}</span>
                ...
                <div className="row" style={{marginBottom: '2.5rem'}}>
                  ...
                  <div className="col-md-8">
                  <div class="inputBox">
                  <select id="bookColor" name="bookcolor"  ref="bookColor"  className="input select" required>
              ...
              <div className="card-footer" style={{paddingTop: '0rem'}}>
                <div className="row">
                  ...
                  <div className="col-md-8">
                    ...
                    <button                                  
                       className="mybtn animated-btn bluebtn" style={{width: '40%'}}
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="card-right bg-gradient br-10" style={{width: '100%', textAlign: 'center', padding: '.5rem'}}>
                      ...
                      <div className="employees">
                        ...
                        {isLoggedIn ? parseFloat(this.state.prodcostx).toFixed(2) : 0}
                          {/* {parseFloat(this.state.prodcostx).toFixed(2)} */}
                  ...
                  <div className="col-md-6 sm-pd">
                    <div className="card-right bg-gradient br-10" style={{width: '100%', textAlign: 'center', padding: '.5rem'}}>
                      <label style={{color: '#fff', fontSize: '15px'}}>Minimum Recommended Price</label>
                      <div className="employees">
                        <span style={{color: 'white', paddingTop: '2px', marginTop: 0, marginBottom: 0, fontSize: '30px', marginRight: '3px'}}>₹</span> 
                        <span className="counter-count" style={{color: 'white', paddingTop: '2px', marginTop: 0, marginBottom: 0, fontSize: '20px'}}>{this.state.minprice}</span>
                ...
                <div className="row" style={{marginBottom: '2.5rem'}}>
                  <div className="col-md-12" style={{marginTop: '10px'}}>
                    ...
                    Set a selling price above the Minimum Selling Price and hit 'Calculate' to see how much you earn.
                    </span> */}
                  <span style={{color: '#9b9b9b', fontWeight: 'bold'}}> 
                  MRP should not be less than  recommended price.</span>
                  </div>
                  <div className="col-md-4">
                    {/* <label className style={{marginTop: '20px'}}>Set Selling Price (INR)</label> */}
                    <label className style={{marginTop: '20px'}}>MRP</label>
                  </div>
                  <div className="col-md-8">
                    <div className="form__group field">
                      <input  onChange={this.handleOnChange1} value={this.state.setmrp} ref="setmrp" type="input" className="form__field" placeholder="Set Selling Price (INR)" id="Set Selling Price (INR)" name="Set Selling Price (INR)" required />
                      <label htmlFor="Set Selling Price (INR)" className="form__label">MRP here</label>
          ...
          <div className="card-right br-10 shadow" style={{width: '100%', textAlign: 'center', padding: '.5rem'}}>
            <label style={{fontSize: '15px'}}>Author copies - at subsidized price : <span className="text-danger"> ₹{this.state.prodsubcostx}</span></label>
            <p style={{fontSize: '14px'}}>
              This is the price at which you can purchase your own book. Minimum number of copies per order is 20.
              Delevery charges extra as per Location.
            </p>
          </div>
        </div>
        </div>
