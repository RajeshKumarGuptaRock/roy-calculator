...
class royaltyCalculator extends Component {
    constructor() {
      ...
      handleValidation(){
        ...
        if(fields <= 50){
          formIsValid = false;
          errors["name"] = "Please enter greater than 50 number of pages";
        }
    ...
    render(){
      ...
      if(this.state.hiddenProductioncast == 'true'){
        productioncast1 = (
          <div className="card-header  br-10" style={{width: '100%', textAlign: 'center', padding: '0rem'}}>
          <label style={{color: '#dc3545', fontSize: '15px'}}>Production Cost</label>
          <div className="employees">
            <span style={{color: '#dc3545', paddingTop: '2px', fontSize: '30px', marginRight: '3px'}}>₹</span>
            <span className="counter-count" style={{color: '#dc3545', paddingTop: '2px', fontSize: '20px'}}>
      ...
      if (this.state.hidden == 'true') {
        ...
        <div className="personCard">
           <div className="footerEbook card-right br-10 shadow" style={{width: '100%', textAlign: 'center', padding: '.5rem'}}>
            <label style={{fontSize: '15px'}}>Author's copies - at subsidised price : <span className="text-danger"> ₹{this.state.prodsubcostx}</span></label>
 ...
 <ProductWrapper>
                ...
                {/*<h5 className="text-center"> Royalty Calculator</h5>
   ...
   <div className="container">
     ...
     <div className="col-md-5 sm-pd">
            <div className="card br-20 shadow" style={{padding: '2rem', backgroundColor: 'white'}}>
...
<span style={{color: "red"}}>{this.state.errors["name"]}</span>
              ...
              <div className="card-footer" style={{paddingTop: '0rem'}}>
                <div className="row">
                  <div className="col-md-6">
                  </div>
                  <div className="col-md-6">
                    ...
                    <button                                  
                       className="mybtn animated-btn bluebtn" style={{width: '100%'}}
          ...
          <div className="col-md-5" style={{marginBottom:'2rem'}}>
            <div className="card shadow br-20" style={{padding: '2rem', paddingBottom: '1rem', backgroundColor: 'white'}}>
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-6 sm-pd">
                    <div className="card-header  br-10" style={{width: '100%', textAlign: 'center', padding: '0rem'}}>
                      <label style={{ fontSize: '15px',color:'#dc3545'}}> Recommended Price</label>
                      <div className="employees">
                        <span style={{ paddingTop: '2px', fontSize: '30px', marginRight: '3px'}}>₹</span> 
                        <span className="counter-count" style={{paddingTop: '2px', marginTop: 0, marginBottom: 0, fontSize: '20px'}}>{this.state.minprice}</span>
              ...
              <div className="row">
                <div className="col-md-6 sm-pd ">
                  <div className="card-header br-10" style={{width: '100%', textAlign: 'center', padding: '0rem'}}>
                    <label style={{color: '#dc3545', fontSize: '15px'}}>BFC Publications</label>
                    <div className="employees">
                      <span style={{color: '#dc3545', paddingTop: '2px', fontSize: '30px', marginRight: '3px'}}>₹</span> <span className="counter-count" style={{color: '#dc3545', paddingTop: '2px', fontSize: '20px'}}>{this.state.bfcprice}</span> 
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="card-header br-10" style={{width: '100%', textAlign: 'center', padding: '0rem'}}>
                    <label style={{color: '#dc3545', fontSize: '15px'}}>Other Stores</label>
                    <div className="employees">
                      <span style={{color: '#dc3545', paddingTop: '2px', fontSize: '30px', marginRight: '3px'}}>₹</span> <span className="counter-count" style={{color: '#dc3545', paddingTop: '2px', fontSize: '20px'}}>{this.state.otherprice}</span> 
                    </div>
                  </div>
                </div>
               
              </div>
              <span style={{fontSize:'12px', color:'#9b9b9b'}}>These Rates are for illustration purpose only. Actual earnings may vary.</span>
            </div>
          </div>
            <div className="col-md-1">
            </div>
